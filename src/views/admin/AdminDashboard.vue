    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      >
        <div class="flex items-start justify-between">
          ...
          <div class="p-3 bg-primary-soft rounded-lg">
            <component
        ...
        <div class="p-4 space-y-3">
          ...
          >
            ...
            <div>
              ...
              <p class="text-xs text-gray-500">Check performance metrics</p>
            </div>
          </button>
        </div>
      </BaseCard>
      ...
      <div class="p-4">
        <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
          <div class="text-center">
            ...
            <p class="text-xs text-gray-400">Connect analytics to view real data</p>
          </div>
        </div>
      </div>
    </BaseCard>
